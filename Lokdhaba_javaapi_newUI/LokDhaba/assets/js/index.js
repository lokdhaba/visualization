...
$(document).ready(function(){	
	...
	$('.autocomplete input.autocomplete-input').on('keyup',function(){
		...
		$(this).parent().siblings('ul.autocomplete-list').addClass('js-dropdown-active')
		$(this).parent().siblings('ul.autocomplete-list').attr('aria-hidden',false);
	...
	$('.autocomplete-dropdown').on('click',function(e){
		...
		$(this).find('ul.autocomplete-list').find('li').each(function(){
